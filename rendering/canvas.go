...
// 	fmt.Printf("\033[?25l") // скрывает курсор во время игры
// }

// // -----------------------------------------------------------------------------------------------------------|

// func (C *Canvas) ShowCursor() {
// 	fmt.Printf("\033[?25h") // показываем курсор после завершения игры
// }

// // -----------------------------------------------------------------------------------------------------------|

// func (C *Canvas) SetCursor(x, y int) {
// 	fmt.Printf("\033[%d;%dH", y, x) // устанавливаем позицию курсора
// }

// // -----------------------------------------------------------------------------------------------------------|

// func (C *Canvas) RestoreCursorPosition() {
// 	fmt.Printf("\033[u") // восстанавливаем положение курсора
// }

// // -----------------------------------------------------------------------------------------------------------|

// func (C *Canvas) SaveCursorPosition() {
// 	fmt.Printf("\033[s") // сохраняем текущее положение курсора
// }
